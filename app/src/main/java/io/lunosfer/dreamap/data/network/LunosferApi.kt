...
/**
 * lunosfer.com'daki Next.js API route'larına (pages/api/**) karşılık gelen
 ...
 * çağıran taraf olan Repository sınıflarında (data/repository/*.kt) verilir.
 */
interface LunosferApi {

    // --- Home (pages/api/home-feed.js) ---
    ...
    // --- Explore (pages/api/explore/feed.js) ---
    ...
    // --- Vision / Goals (pages/api/goals/list.js) ---
    ...
    // --- Messages (pages/api/messages/*.js) ---
